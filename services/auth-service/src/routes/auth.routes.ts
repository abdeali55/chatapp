import { loginHandler, refreshTokenHandler, registerHandler, revokeHandler } from "@/controllers/auth.controller";
...
authRouter.post("/refresh", validateRequest({body: refreshSchema.shape.body}), refreshTokenHandler);
